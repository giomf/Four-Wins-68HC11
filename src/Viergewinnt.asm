...
LCDCols 			equ			128				; Horizontale Pixeln des LCD's
LCDRows 			equ			8				; Vertikalen Bytes des LCD's
boardSize			equ			336				; Byteanzahl des Buffers
byteSize			equ			8				; Größe eines Bytes in Bit
rowLength			equ			56				; Zeilenlänge des Spielfeldes
												; in Pixeln

cursorRow			equ			6				; Vertikale Position des Cursors
												; in Byte

boardOffset			equ			36				; horizontaler Versatz des 
												; Spielfeldes

boardMiddleColumn	equ			24				; Die mittlere Spalte des
												; Spielfeldes
...
wonText	
		dc.b 17,$00,$00,$3C,$40,$20,$40,$3C,$00					; w
...
initGame
		...
		jsr		resetCursor				; Setz den Cursor in die Mitte des
										; Spielfeldes
		ldaa	#1	
