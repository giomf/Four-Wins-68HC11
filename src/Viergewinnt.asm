...
cellAddress		ds.w	1				; Die Adresse für eine Zeile des Spielfeldes (Wird als Funktionsparameter benutzt)
cursorColumn	ds.b	1				; Horizontale Position des Cursors in Pixeln
debugCellAdress	ds.w	1				; Die Adresse für eine Zeile des Spielfeldes (Wird als Funktionsparameter fürs Debuging benutzt)
buttonFlag		ds.b	1				; Flag zur Flankenerkennung -> 1 = gedrückt, 0 = nicht gedrückt
timer			ds.b	1				; Timer zum entprellen der Tasten
player			ds.b	1				; Der Spieler der aktuell am Zug ist (1 = Spieler 1, 2 = Spieler 2)
...
playerWonFlag	ds.b	1				; Flag um Tasten zu sperren wenn ein Spieler gewonnen hat
...
turnText   		dc.b 21,$02,$7E,$02,$00			; T
				dc.b $3C,$40,$40,$7C,$00		; u
				dc.b $7C,$08,$04,$08,$00		; r
				dc.b $7C,$08,$04,$78,$00		; n
				dc.b $28,$00					; :
        
playerText		dc.b 30,$7E,$12,$12,$0C,$00 	; P
				dc.b $02,$7E,$00				; l
...
oneText			dc.b 4,$04,$7E,$00,$00			; 1

twoText			dc.b 5,$64,$52,$52,$4C,$00		; 2

wonText			dc.b 17,$00,$00,$3C,$40,$20,$40,$3C,$00	; w
...
Start	lds		#$3FFF					; Einstiegspunkt des Spieles
